CreateGUITextByLanguage(Language, localVersion) {
    ...
    if (Language = 1) {
        ...
        Lang["Txt_ClickDelayMin"] := "Click Delay Min (ms):"
        Lang["Txt_ClickDelayMax"] := "Click Delay Max (ms):"
        ...
        Lang["Txt_Delay"] := "指令延遲："
        Lang["Txt_ClickDelayMin"] := "點擊最小延遲："
        Lang["Txt_ClickDelayMax"] := "點擊最大延遲："
        ...
        Lang["Txt_Delay"] := "遅延："
        Lang["Txt_ClickDelayMin"] := "クリック最小遅延："
        Lang["Txt_ClickDelayMax"] := "クリック最大遅延："
        ...
        Lang["Txt_ClickDelayMin"] := "Min. Klickverzögerung (ms):"
        Lang["Txt_ClickDelayMax"] := "Max. Klickverzögerung (ms):"
