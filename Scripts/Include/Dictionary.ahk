CreateGUITextByLanguage(Language, localVersion) {
    ...
    if (Language = 1) {
        ...
        Lang["Txt_ClickDelayMin"] := "Click Min (ms):"
        Lang["Txt_ClickDelayMax"] := "Click Max (ms):"
        ...
        Lang["Txt_Delay"] := "指令延遲："
        Lang["Txt_ClickDelayMin"] := "點擊最小值："
        Lang["Txt_ClickDelayMax"] := "點擊最大值："
        ...
        Lang["Txt_Delay"] := "遅延："
        Lang["Txt_ClickDelayMin"] := "クリック最小値："
        Lang["Txt_ClickDelayMax"] := "クリック最大値："
        ...
        Lang["Txt_ClickDelayMin"] := "Klick-Min. (ms):"
        Lang["Txt_ClickDelayMax"] := "Klick-Max. (ms):"
