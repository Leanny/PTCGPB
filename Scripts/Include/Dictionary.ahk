CreateGUITextByLanguage(Language, localVersion) {
    ...
    if (Language = 1) {
        ...
        Lang["Txt_hourglassTenPackOpening"] := "Use 10-Pack Mode"
        Lang["Txt_spendHourglassPackCount"] := "Packs to open (0 = all)"
        ...
        Lang["Txt_hourglassTenPackOpening"] := "使用10包模式"
        Lang["Txt_spendHourglassPackCount"] := "開包數(0 = 全部)"
        ...
        Lang["Txt_hourglassTenPackOpening"] := "10パックモード使用"
        Lang["Txt_spendHourglassPackCount"] := "開封数(0 = 全て)"
        ...
        Lang["Txt_hourglassTenPackOpening"] := "10-Pack-Modus nutzen"
        Lang["Txt_spendHourglassPackCount"] := "Packs öffnen (0 = alle)"
        ...
        Lang["Txt_MegaAltaria"] := "Mega-Altaria"
        Lang["Txt_Deluxe"] := "Deluxe-Pack: ex"
